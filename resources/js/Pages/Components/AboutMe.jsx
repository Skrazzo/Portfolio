    ...
    return (
        <main className="container mt-12 max-w-6xl px-4 duration-300 sm:mt-36">
            ...
            <div className="mt-4 flex duration-300">
                ...
                <div>
                    <p className="leading-project-description py-2 text-2xl text-bg-green-light duration-300 sm:text-project-description">
                    ...
                    <p className="leading-project-description mt-4 py-2 text-2xl text-bg-green-light duration-300 sm:text-project-description">
