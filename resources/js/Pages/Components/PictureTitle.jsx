    ...
    return (
        <main className='flex justify-between'>
            ...
            <div className='text-right pt-28'>
                ...
                <h1 className='text-6.25xl font-extrabold'>Full-stack developer</h1>
                <button className='text-bg-green font-bold text-1.75xl rounded-rem bg-red-400 px-8 py-4'>CONTACT ME</button>
            </div>
